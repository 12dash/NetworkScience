...
class Faculty:
    #A node is an excellence node if it has published in top conferences more than this value in the last 10 years
    ...
    #Look through loaded papers to see if the excellence criteria is met
    ...
    def parse_xml(self):
        ...
        #Get Excellence Papers Based on Non-Workshop Results
